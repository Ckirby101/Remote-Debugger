namespace RemoteDebugger.Docks
{
	partial class RegMemWatch
	{
		...
		private void InitializeComponent()
		{
			...
			this.MEMHexControl = new HexControlLibrary.HexControl();
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(442, 460);
			...
			// panel6
			// 
			this.panel6.Controls.Add(this.MEMHexControl);
			this.panel6.Controls.Add(this.MEMlabel);
			...
			// MEMHexControl
			// 
			this.MEMHexControl.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.MEMHexControl.ColumnsPerRow = 16;
			this.MEMHexControl.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.MEMHexControl.Location = new System.Drawing.Point(0, 19);
			this.MEMHexControl.Name = "MEMHexControl";
			this.MEMHexControl.Size = new System.Drawing.Size(443, 46);
			this.MEMHexControl.TabIndex = 2;
			// 
			// MEMlabel
			// 
			this.MEMlabel.AutoSize = true;
			this.MEMlabel.Location = new System.Drawing.Point(5, 3);
			this.MEMlabel.Name = "MEMlabel";
			this.MEMlabel.Size = new System.Drawing.Size(29, 13);
			this.MEMlabel.TabIndex = 1;
			this.MEMlabel.Text = "( IY )";
			// 
			// RegMemWatch
			// 
		...
		private HexControlLibrary.HexControl MEMHexControl;
